      ...
      <AppBar position="static" sx={{ backgroundColor: common.black }}>
        <Toolbar>
          ...
          <Search sx={{ flexGrow: 1 }}>
            ...
            <StyledInputBase
              placeholder={t('layout.searchbar_placeholder')}
              inputProps={{ 'aria-label': 'search' }}
              name="Product search"
            />
          </Search>
          
          <ColorButton variant="contained">{t('search')}</ColorButton>
